...
public class MyTwitterClient extends OAuthBaseClient {
	...
	public static final String REST_URL = "https://api.twitter.com/1.1"; // Change
																			...
																			// API
																			// URL
	public static final String REST_CONSUMER_KEY = "gQcFOKcKzk2xL3hDlLdBgo1wZ"; // Change
																				// this
	public static final String REST_CONSUMER_SECRET = "QDpNbU1VxbcgLHwWtgue7jtiJSx50zIaLoPDIJ3D7WI9dkuIDx"; // Change
																											// this
	...
	public void getHomeTimeLine(AsyncHttpResponseHandler handler, long maxId) {
		...
		if(maxId > 0){
			...
			apiUrl = getApiUrl("statuses/home_timeline.json?count=25");
			params = new RequestParams();
			params.put("count", "25");
		}
